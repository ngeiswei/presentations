...
\begin{frame}
  ...
  % <BEGIN-SPEECH>
  % Here the best schemata were directly provided.  However in
  % practice it's more like that (show many different schemata with
  % their TVs) there can be many schemata, possibly
  % thousands, providing very different estimates about the likelihood
